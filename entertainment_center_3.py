...
minions = media.Movie("Minions",
                      "A movie about evil helpers trying to take over the \
                      world",
                      "https://upload.wikimedia.org/wikipedia/en/3/3d/\
                      Minions_poster.jpg",  # NOQA
...
nerve = media.Movie("Nerve",
                    ...
                    MV5BMTUzOTg1OTM4NV5BMl5BanBnXkFtZTgwMTg2Mjg0OTE@\
                    ._V1_UX182_CR0,0,182,268_AL_.jpg",  # NOQA
                    "https://www.youtube.com/watch?v=Tyk2_bzca3E")  # NOQA
# print(nerve.storyline)
# nerve.show_trailer()

a_walk_to_remember = media.Movie("A Walk to Remember",
                                 "A lovestory about a dying girl befriending \
                                 a bully",
                                 "https://upload.wikimedia.org/wikipedia/en/\
                                 thumb/d/dc/A_Walk_to_Remember_Poster.jpg/\
                                 220px-A_Walk_to_Remember_Poster.jpg",  # NOQA
