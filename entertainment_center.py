...
fast_and_furious = media.Movie("The Fast and the Furious",
                               "A movie about illegal street racing and heists",
                               "https://i.sharefa.st/8TFpgq0Pnv10.jpg",
...
minions = media.Movie("Minions",
                      "A movie about evil helpers trying to take over the world",
...
lilo_and_stitch = media.Movie("Lilo and Stitch",
                              "A movie about aliens creations and the meaning of family in Hawaii",
...
nerve = media.Movie("Nerve",
                    ...
                    "https://www.youtube.com/watch?v=Tyk2_bzca3E")
# print(nerve.storyline)
# nerve.show_trailer()

a_walk_to_remember = media.Movie("A Walk to Remember",
                                 "A lovestory about a dying girl befriending a bully",
...
movies =[fast_and_furious,minions,mulan,lilo_and_stitch,nerve,a_walk_to_remember]
